...
export async function registerStartingContent(
  ...
  const goblinChief: EnemyStatsConfig = {
    ...
    enemy_type: 9,
    hp: 140,
    moves: [{ attack: 10, block_self: 17 }, { attack: 25 }, { attack: 15, block_self: 12 }],
  ...
  const tentacles: EnemyStatsConfig = {
    ...
    enemy_type: 10,
    hp: 90,
    moves: [{ attack: 15, heal_self: 12 }, { block_self: 17, heal_self: 12 }, { attack: 10, block_self: 6, heal_self: 12 }],
    physical_def: Def.WEAK,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.NEUTRAL,
  };
  ...
  const hellspawnStrong: EnemyStatsConfig = {
    ...
    enemy_type: 6,
    hp: 140,
    moves: [{ attack: 60 }, { attack: 45, heal_self: 17 }],
    physical_def: Def.IMMUNE,
    fire_def: Def.WEAK,
    ice_def: Def.SUPEREFFECTIVE,
  };
  const hellspawnElite: EnemyStatsConfig = {
    ...
    enemy_type: 6,
    hp: 185,
    moves: [{ attack: 80 }, { attack: 60, heal_self: 23 }],
    physical_def: Def.IMMUNE,
    fire_def: Def.WEAK,
    ice_def: Def.SUPEREFFECTIVE,
  };
  ...
  const iceGolem: EnemyStatsConfig = {
    ...
    enemy_type: 5,
    hp: 90,
    moves: [{ attack: 5, block_self: 17 }, { block_self: 45 }, { attack: 10, block_self: 12 }],
    physical_def: Def.WEAK,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.IMMUNE,
  };
  const iceGolemStrong: EnemyStatsConfig = {
    ...
    enemy_type: 5,
    hp: 140,
    moves: [{ attack: 8, block_self: 25 }, { block_self: 70 }, { attack: 15, block_self: 17 }],
    physical_def: Def.WEAK,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.IMMUNE,
  };
  const iceGolemElite: EnemyStatsConfig = {
    ...
    enemy_type: 5,
    hp: 185,
    moves: [{ attack: 10, block_self: 35 }, { block_self: 90 }, { attack: 20, block_self: 23 }],
    physical_def: Def.WEAK,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.IMMUNE,
  };
  ...
  const goblin: EnemyStatsConfig = {
    enemy_type: 0,
    hp: 35,
    moves: [{ attack: 5, block_self: 6 }, { attack: 10 }, { block_self: 12 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.NEUTRAL,
    ice_def: Def.NEUTRAL,
  };
  const goblinStrong: EnemyStatsConfig = {
    enemy_type: 0,
    hp: 50,
    moves: [{ attack: 10, block_self: 6 }, { attack: 15 }, { block_self: 17 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.NEUTRAL,
    ice_def: Def.NEUTRAL,
  };
  const goblinElite: EnemyStatsConfig = {
    enemy_type: 0,
    hp: 70,
    moves: [{ attack: 10, block_self: 12 }, { attack: 20 }, { block_self: 23 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.NEUTRAL,
    ice_def: Def.NEUTRAL,
  };
  ...
  const pyramid: EnemyStatsConfig = {
    enemy_type: 4,
    hp: 60,
    moves: [{ attack: 20 }, { block_allies: 12 }, { heal_allies: 12 }],
    physical_def: Def.IMMUNE,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.EFFECTIVE,
  };
  const pyramidStrong: EnemyStatsConfig = {
    enemy_type: 4,
    hp: 85,
    moves: [{ attack: 30 }, { block_allies: 17 }, { heal_allies: 17 }],
    physical_def: Def.IMMUNE,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.EFFECTIVE,
  };
  const pyramidElite: EnemyStatsConfig = {
    enemy_type: 4,
    hp: 115,
    moves: [{ attack: 40 }, { block_allies: 23 }, { heal_allies: 23 }],
    physical_def: Def.IMMUNE,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.EFFECTIVE,
  };
  ...
  const goblinPriest: EnemyStatsConfig = {
    enemy_type: 7,
    hp: 35,
    moves: [{ block_self: 6, block_allies: 12 }, { heal_allies: 17 }, { attack: 10, block_allies: 6 }],
  ...
  const goblinPriestStrong: EnemyStatsConfig = {
    enemy_type: 7,
    hp: 50,
    moves: [{ block_self: 8, block_allies: 17 }, { heal_allies: 25 }, { attack: 15, block_allies: 9 }],
    physical_def: Def.SUPEREFFECTIVE,
    fire_def: Def.WEAK,
    ice_def: Def.WEAK,
  };
  const goblinPriestElite: EnemyStatsConfig = {
    enemy_type: 7,
    hp: 70,
    moves: [{ attack: 20, block_allies: 12 }, { heal_allies: 35 }, { block_self: 12, block_allies: 23 }],
    physical_def: Def.SUPEREFFECTIVE,
    fire_def: Def.WEAK,
    ice_def: Def.WEAK,
  };
  ...
  const goblinSwordmaster: EnemyStatsConfig = {
    enemy_type: 8,
    hp: 23,
    moves: [{ attack: 10, block_self: 3 }, { attack: 10 }, { attack: 15 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.NEUTRAL,
    ice_def: Def.NEUTRAL,
  };
  const goblinSwordmasterStrong: EnemyStatsConfig = {
    enemy_type: 8,
    hp: 40,
    moves: [{ attack: 25, block_self: 6 }, { attack: 15 }, { attack: 20 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.NEUTRAL,
    ice_def: Def.NEUTRAL,
  };
  const goblinSwordmasterElite: EnemyStatsConfig = {
    enemy_type: 8,
    hp: 60,
    moves: [{ attack: 45, block_self: 10 }, { attack: 20 }, { attack: 30 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.NEUTRAL,
    ice_def: Def.NEUTRAL,
  };
  ...
  const snowman: EnemyStatsConfig = {
    enemy_type: 3,
    hp: 30,
    moves: [{ attack: 20 }, { attack: 15, block_self: 6 }, { attack: 10 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.WEAK,
  };
  const snowmanStrong: EnemyStatsConfig = {
    enemy_type: 3,
    hp: 45,
    moves: [{ attack: 30 }, { attack: 20, block_self: 9 }, { attack: 15 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.WEAK,
  };
  const snowmanElite: EnemyStatsConfig = {
    enemy_type: 3,
    hp: 60,
    moves: [{ attack: 40 }, { attack: 30, block_self: 12 }, { attack: 20 }],
    physical_def: Def.NEUTRAL,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.WEAK,
  };
  ...
  const tentacle: EnemyStatsConfig = {
    enemy_type: 11,
    hp: 35,
    moves: [{ attack: 10, heal_self: 6 }, { block_self: 12, heal_self: 6 }, { attack: 5, block_self: 6, heal_self: 6 }],
    physical_def: Def.WEAK,
    fire_def: Def.EFFECTIVE,
    ice_def: Def.NEUTRAL,
  };
